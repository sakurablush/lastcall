...
[![CodeQL](https://github.com/sakurablush/lastcall/actions/workflows/codeql.yml/badge.svg)](https://github.com/sakurablush/lastcall/actions/workflows/codeql.yml)
...
npm run test:coverage     # 100% line coverage (98% branch threshold)
```
