...
const FEATURE_MATRIX = [
  ...
  {
    feature: 'production scenarios (K8s lifecycle, diamond deps, HTTP load)',
    tests: ['test/unit/production-scenarios.test.ts'],
    keywords: ['Kubernetes-style lifecycle', 'diamond dependency', 'production scenarios'],
  },
  {
    feature: 'negative registration and shutdown guards',
    tests: ['test/unit/production-scenarios.test.ts', 'test/unit/create-lastcall.test.ts'],
    keywords: ['negative paths', 'shutdown is in progress'],
  },
] as const;
