...
V8 coverage instrumentation reports ~98% branches in `shutdown-runner.ts` due to `try/catch/finally` bytecode mapping. All logical paths are tested; the global threshold is set to 99% to account for this artifact.
